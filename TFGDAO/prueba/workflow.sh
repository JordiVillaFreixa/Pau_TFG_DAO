...
antechamber -fi ccif -i NAG.cif -bk NAG -fo ac -o nag6.ac -c bcc -at amber -nc 0 -rn NAG

parmchk2 -f ac -i nag6.ac -o frcmod.nag6

prepgen -i nag6.ac -o nag6.prepin -m nag.mc -rn NAG

parmchk2 -f prepi -i nag6.prepin -o frcmod.nag6